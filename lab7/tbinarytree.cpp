...
template <class Poligon>
Iterator<TreeElem<Poligon>, Poligon> TBinaryTree<Poligon>::begin(){
    return Iterator<TreeElem<Poligon>, Poligon>(t_root);
}

template <class Poligon>
Iterator<TreeElem<Poligon>, Poligon> TBinaryTree<Poligon>::end(){
    SPTR(TreeElem<Poligon>) curr = t_root;
    while (curr->get_right()) curr = curr->get_right();
    return Iterator<TreeElem<Poligon>, Poligon>(curr);
}
...
template std::ostream& operator<<(std::ostream& os, const TBinaryTree<Octagon>& stac);